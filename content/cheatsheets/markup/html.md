...
Get the code: [learnhtml.txt](https://learnxinyminutes.com/files/learnhtml.txt)
...
**NOTE:** You can test the different tags and elements as you progress through the tutorial on a site like [codepen](http://codepen.io/pen/) in order to see their effects, understand how they work and familiarise yourself with the language. This article is concerned principally with HTML syntax and some useful tips.
...
HTML is written in files ending with `.html` or `.htm`. The mime type is `text/html`. **HTML is NOT a programming language**
...
Got a suggestion? A correction, perhaps? [Open an Issue](https://github.com/adambard/learnxinyminutes-docs/issues/new) on the GitHub Repo, or make a [pull request](https://github.com/adambard/learnxinyminutes-docs/edit/master/html.md) yourself!

Originally contributed by Christophe THOMAS, and updated by [7 contributors](https://github.com/adambard/learnxinyminutes-docs/blame/master/html.md).
