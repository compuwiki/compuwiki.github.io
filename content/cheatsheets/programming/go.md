...
Get the code: [learngo.go](https://learnxinyminutes.com/files/learngo.go)
...
Got a suggestion? A correction, perhaps? [Open an Issue](https://github.com/adambard/learnxinyminutes-docs/issues/new) on the GitHub Repo, or make a [pull request](https://github.com/adambard/learnxinyminutes-docs/edit/master/go.md) yourself!

Originally contributed by Sonia Keys, and updated by [46 contributors](https://github.com/adambard/learnxinyminutes-docs/blame/master/go.md).
