...
Get the code: [wikitext.md](https://learnxinyminutes.com/files/wikitext.md)
...
`*` Unnumbered lists start with `*`, and numbered lists start with `#`.  
  `**` Lists can be nested  
...
Got a suggestion? A correction, perhaps? [Open an Issue](https://github.com/adambard/learnxinyminutes-docs/issues/new) on the GitHub Repo, or make a [pull request](https://github.com/adambard/learnxinyminutes-docs/edit/master/wikitext.md) yourself!

Originally contributed by Yuxi Liu, and updated by [2 contributors](https://github.com/adambard/learnxinyminutes-docs/blame/master/wikitext.md).