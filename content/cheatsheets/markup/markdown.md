...
Get the code: [markdown.md](https://learnxinyminutes.com/files/markdown.md)
...
In order to simplify work with Markdown and to unify its coding style, `Markdownlint` has been created. Available as a [separate tool](https://github.com/markdownlint/markdownlint) as well as a plugin for some IDEs, it can be used to ensure validity and readability of Markdown.
...
Got a suggestion? A correction, perhaps? [Open an Issue](https://github.com/adambard/learnxinyminutes-docs/issues/new) on the GitHub Repo, or make a [pull request](https://github.com/adambard/learnxinyminutes-docs/edit/master/markdown.md) yourself!

Originally contributed by Dan Turkel, and updated by [16 contributors](https://github.com/adambard/learnxinyminutes-docs/blame/master/markdown.md).
