...
Get the code: [LearnCSharp.cs](https://learnxinyminutes.com/files/LearnCSharp.cs)
...
Got a suggestion? A correction, perhaps? [Open an Issue](https://github.com/adambard/learnxinyminutes-docs/issues/new) on the GitHub Repo, or make a [pull request](https://github.com/adambard/learnxinyminutes-docs/edit/master/csharp.md) yourself!

Originally contributed by Irfan Charania, and updated by [39 contributors](https://github.com/adambard/learnxinyminutes-docs/blame/master/csharp.md).