...
Get the code: [learnyaml.yaml](https://learnxinyminutes.com/files/learnyaml.yaml)
...
Got a suggestion? A correction, perhaps? [Open an Issue](https://github.com/adambard/learnxinyminutes-docs/issues/new) on the GitHub Repo, or make a [pull request](https://github.com/adambard/learnxinyminutes-docs/edit/master/yaml.md) yourself!

Originally contributed by Leigh Brenecki, and updated by [17 contributors](https://github.com/adambard/learnxinyminutes-docs/blame/master/yaml.md).