...
Get the code: [LearnKotlin.kt](https://learnxinyminutes.com/files/LearnKotlin.kt)

Kotlin is a statically typed programming language for the JVM, Android and the browser. It is 100% interoperable with Java. [Read more here.](https://kotlinlang.org/)
...
Got a suggestion? A correction, perhaps? [Open an Issue](https://github.com/adambard/learnxinyminutes-docs/issues/new) on the GitHub Repo, or make a [pull request](https://github.com/adambard/learnxinyminutes-docs/edit/master/kotlin.md) yourself!

Originally contributed by S Webber, and updated by [21 contributors](https://github.com/adambard/learnxinyminutes-docs/blame/master/kotlin.md).
