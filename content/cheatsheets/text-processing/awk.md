...
Get the code: [learnawk.awk](https://learnxinyminutes.com/files/learnawk.awk)
...
Got a suggestion? A correction, perhaps? [Open an Issue](https://github.com/adambard/learnxinyminutes-docs/issues/new) on the GitHub Repo, or make a [pull request](https://github.com/adambard/learnxinyminutes-docs/edit/master/awk.md) yourself!

Originally contributed by Marshall Mason, and updated by [13 contributors](https://github.com/adambard/learnxinyminutes-docs/blame/master/awk.md).