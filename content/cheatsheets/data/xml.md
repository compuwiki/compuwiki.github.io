...
Get the code: [learnxml.xml](https://learnxinyminutes.com/files/learnxml.xml)
...
Got a suggestion? A correction, perhaps? [Open an Issue](https://github.com/adambard/learnxinyminutes-docs/issues/new) on the GitHub Repo, or make a [pull request](https://github.com/adambard/learnxinyminutes-docs/edit/master/xml.md) yourself!

Originally contributed by João Farias, and updated by [10 contributors](https://github.com/adambard/learnxinyminutes-docs/blame/master/xml.md).
