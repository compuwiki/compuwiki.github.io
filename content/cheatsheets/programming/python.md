...
Get the code: [learnpython.py](https://learnxinyminutes.com/files/learnpython.py)
...
Got a suggestion? A correction, perhaps? [Open an Issue](https://github.com/adambard/learnxinyminutes-docs/issues/new) on the GitHub Repo, or make a [pull request](https://github.com/adambard/learnxinyminutes-docs/edit/master/python.md) yourself!

Originally contributed by Louie Dinh, and updated by [71 contributors](https://github.com/adambard/learnxinyminutes-docs/blame/master/python.md).
