...
Get the code: [Makefile](https://learnxinyminutes.com/files/Makefile)
...
Got a suggestion? A correction, perhaps? [Open an Issue](https://github.com/adambard/learnxinyminutes-docs/issues/new) on the GitHub Repo, or make a [pull request](https://github.com/adambard/learnxinyminutes-docs/edit/master/make.md) yourself!

Originally contributed by Robert Steed, and updated by [1 contributor](https://github.com/adambard/learnxinyminutes-docs/blame/master/make.md).
