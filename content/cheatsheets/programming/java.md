...
Get the code: [LearnJava.java](https://learnxinyminutes.com/files/LearnJava.java)

Java is a general-purpose, concurrent, class-based, object-oriented computer programming language. [Read more here.](https://docs.oracle.com/javase/tutorial/java/)
...
Got a suggestion? A correction, perhaps? [Open an Issue](https://github.com/adambard/learnxinyminutes-docs/issues/new) on the GitHub Repo, or make a [pull request](https://github.com/adambard/learnxinyminutes-docs/edit/master/java.md) yourself!

Originally contributed by Jake Prather, and updated by [57 contributors](https://github.com/adambard/learnxinyminutes-docs/blame/master/java.md).