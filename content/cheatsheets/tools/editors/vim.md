...
Get the code: [LearnVim.txt](https://learnxinyminutes.com/files/LearnVim.txt)
...
Got a suggestion? A correction, perhaps? [Open an Issue](https://github.com/adambard/learnxinyminutes-docs/issues/new) on the GitHub Repo, or make a [pull request](https://github.com/adambard/learnxinyminutes-docs/edit/master/vim.md) yourself!

Originally contributed by RadhikaG, and updated by [14 contributors](https://github.com/adambard/learnxinyminutes-docs/blame/master/vim.md).