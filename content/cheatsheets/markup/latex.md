...
Get the code: [learn-latex.tex](https://learnxinyminutes.com/files/learn-latex.tex)
...
Got a suggestion? A correction, perhaps? [Open an Issue](https://github.com/adambard/learnxinyminutes-docs/issues/new) on the GitHub Repo, or make a [pull request](https://github.com/adambard/learnxinyminutes-docs/edit/master/latex.md) yourself!

Originally contributed by Chaitanya Krishna Ande, and updated by [16 contributors](https://github.com/adambard/learnxinyminutes-docs/blame/master/latex.md).