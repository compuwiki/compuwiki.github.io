...
Get the code: [learnjson.json](https://learnxinyminutes.com/files/learnjson.json)
...
Got a suggestion? A correction, perhaps? [Open an Issue](https://github.com/adambard/learnxinyminutes-docs/issues/new) on the GitHub Repo, or make a [pull request](https://github.com/adambard/learnxinyminutes-docs/edit/master/json.md) yourself!

Originally contributed by Anna Harren, and updated by [13 contributors](https://github.com/adambard/learnxinyminutes-docs/blame/master/json.md).