...
Got a suggestion? A correction, perhaps? [Open an Issue](https://github.com/adambard/learnxinyminutes-docs/issues/new) on the GitHub Repo, or make a [pull request](https://github.com/adambard/learnxinyminutes-docs/edit/master/csv.md) yourself!

Originally contributed by Timon Erhart, and updated by [2 contributors](https://github.com/adambard/learnxinyminutes-docs/blame/master/csv.md).
